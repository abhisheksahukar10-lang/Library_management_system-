...
public class FineService {
    ...
    public List<Fine> getFinesForUser(@NonNull Long userId) {
        return fineRepository.findByUserId(userId);
    }

    public List<Fine> getUnpaidFines(@NonNull Long userId) {
        return fineRepository.findByUserIdAndPaid(userId, false);
    }

    public Optional<Fine> getFineById(@NonNull Long id) {
        return fineRepository.findById(id);
    }

    public Fine payFine(@NonNull Long fineId) {
